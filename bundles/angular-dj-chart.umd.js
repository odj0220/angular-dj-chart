(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('d3'), require('rxjs/internal-compatibility'), require('moment'), require('dc'), require('d3-cloud'), require('lodash'), require('d3-selection'), require('d3-dispatch'), require('d3-scale-chromatic'), require('d3-time'), require('d3-array'), require('d3-scale'), require('d3-axis'), require('d3-zoom'), require('d3-brush'), require('d3-interpolate')) :
    typeof define === 'function' && define.amd ? define('angular-dj-chart', ['exports', '@angular/core', 'd3', 'rxjs/internal-compatibility', 'moment', 'dc', 'd3-cloud', 'lodash', 'd3-selection', 'd3-dispatch', 'd3-scale-chromatic', 'd3-time', 'd3-array', 'd3-scale', 'd3-axis', 'd3-zoom', 'd3-brush', 'd3-interpolate'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['angular-dj-chart'] = {}, global.ng.core, global.d3, global.rxjs['internal-compatibility'], global.moment$1, global.dc, global._d3Cloud, global._, global.d3Selection, global.d3Dispatch, global.d3ScaleChromatic, global.d3Time, global.d3Array, global.d3Scale, global.d3Axis, global.d3Zoom, global.d3Brush, global.d3Interpolate));
}(this, (function (exports, i0, d3, internalCompatibility, moment$1, dc, _d3Cloud, _, d3Selection, d3Dispatch, d3ScaleChromatic, d3Time, d3Array, d3Scale, d3Axis, d3Zoom, d3Brush, d3Interpolate) { 'use strict';
    ...
    var AngularDjChartService = /** @class */ (function () {
        function AngularDjChartService() {
        }
        return AngularDjChartService;
    }());
    AngularDjChartService.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartService, deps: [], target: i0__namespace.ɵɵFactoryTarget.Injectable });
    AngularDjChartService.ɵprov = i0__namespace.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartService, providedIn: 'root' });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartService, decorators: [{
                type: i0.Injectable,
                args: [{
                        providedIn: 'root'
                    }]
    ...
    ***************************************************************************** */
    ...
    var AngularDjChartComponent = /** @class */ (function () {
        function AngularDjChartComponent(elRef, zone) {
            this.elRef = elRef;
            this.zone = zone;
        ...
        Object.defineProperty(AngularDjChartComponent.prototype, "option", {
            get: function () {
                // @ts-ignore
                return this._option;
            },
        ...
        AngularDjChartComponent.prototype.ngOnInit = function () {
            var _this = this;
            // init document width
        ...
        AngularDjChartComponent.prototype.ngOnDestroy = function () {
            // 생성된 tooltip 제거
            if (this._tooltip) {
        ...
        AngularDjChartComponent.prototype.create = function () {
            var _this = this;
            this.setWidthHeight();
            this.setMargins();
        ...
        AngularDjChartComponent.prototype.setPieChart = function () {
            var _this = this;
            this.create();
        ...
        AngularDjChartComponent.prototype.setDcChart = function () {
            var _this = this;
            // @ts-ignore
        ...
        AngularDjChartComponent.prototype.setCloudChart = function () {
            this.create();
            this.chart.padding(this.option.padding);
            this.chart.legends(this.option.legends);
        };
        AngularDjChartComponent.prototype.setMargins = function () {
        ...
        AngularDjChartComponent.prototype.setMultiSeries = function () {
            var _this = this;
            this.create();
        ...
        AngularDjChartComponent.prototype.setLeftYAxis = function () {
            var _this = this;
        ...
        AngularDjChartComponent.prototype.setWidthHeight = function () {
        ...
        AngularDjChartComponent.prototype.filter = function () {
            var _this = this;
        ...
        AngularDjChartComponent.prototype.getFilters = function () {
        ...
        AngularDjChartComponent.prototype.getTooltipElem = function () {
            if (!this._tooltip || this._tooltip.empty()) {
                this._tooltip = d3__namespace.select('body')
                    .append('div')
                    .attr('class', 'wise-chart-tooltip')
        ...
        AngularDjChartComponent.prototype.renderHighlight = function (chart) {
            var _this = this;
            var g = chart.g();
        ...
        AngularDjChartComponent.prototype.commaSeparateNumber = function (value) {
            if (!value) {
                return '';
            }
    ...
    var AngularDjChartModule = /** @class */ (function () {
        function AngularDjChartModule() {
        }
        return AngularDjChartModule;
    }());
    AngularDjChartModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartModule, deps: [], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    AngularDjChartModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartModule, declarations: [AngularDjChartComponent], exports: [AngularDjChartComponent] });
    AngularDjChartModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartModule, imports: [[]] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.1.1", ngImport: i0__namespace, type: AngularDjChartModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        declarations: [
    ...
    exports.AngularDjChartComponent = AngularDjChartComponent;
    exports.AngularDjChartModule = AngularDjChartModule;
    exports.AngularDjChartService = AngularDjChartService;
    exports.AxisOption = AxisOption;
    exports.DjChartOption = DjChartOption;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=angular-dj-chart.umd.js.map
